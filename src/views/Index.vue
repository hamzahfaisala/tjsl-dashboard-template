        ...
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            <h2 class="font-semibold text-4xl text-blueGray-600">
              Tanggung Jawab Sosial Perusahaan Telkom (TJSL)
            </h2>
            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
              Duis dignissim sapien quis felis mattis, id iaculis tortor ullamcorper. Sed ultrices elementum malesuada. Nulla a metus interdum, ullamcorper augue nec, faucibus felis. Mauris dapibus.
            </p>
            <div class="mt-12">
              <a
                href="#"
            ...
            >
              ...
              <blockquote class="relative p-8 mb-4">
                ...
                <h4 class="text-xl font-bold text-white">
                  Etiam auctor justo nibh, in.
                </h4>
                <p class="text-md font-light mt-2 text-white">
                 Mauris dignissim risus quis sem aliquet, semper eleifend tellus euismod. Vivamus luctus dui vitae massa pulvinar, at ullamcorper massa maximus. Morbi cursus, nulla varius lobortis.
                </p>
              </blockquote>
            </div>
          </div>
              ...
              <div class="w-full md:w-6/12 px-4">
                <div class="relative flex flex-col mt-4">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      Donec consequat tempor tellus, nec feugiat urna congue eu. Proin.
                    </p>
                  </div>
                </div>
                <div class="relative flex flex-col min-w-0">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      Fusce id purus nisl. Aliquam sed mauris erat. Morbi ac.
                    </p>
                  </div>
                </div>
              </div>
              <div class="w-full md:w-6/12 px-4">
                <div class="relative flex flex-col min-w-0 mt-4">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <h6 class="text-xl mb-1 font-semibold">Integer ac.</h6>
                    <p class="mb-4 text-blueGray-500">
                      Quisque lorem eros, iaculis id aliquam sollicitudin, lorem luctus ut elit.
                    </p>
                  </div>
                </div>
                <div class="relative flex flex-col min-w-0">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-blueGray-500">
                      Sed vel tellus sit amet lectus placerat finibus ac a.
                    </p>
                  </div>
                </div>
              </div>
